...
const DonationTab = observer(() => {
  ...
  const donationProducts = [
    ...
    // Новичковые товары (категория beginner)
    {
      id: 10,
      name: "🎁 Набор новичка",
      description: "Стартовый набор: оружие +2, броня +2 (4 предмета), осёл, золото на 50 далеонов по курсу",
      price: 100,
      currency: "💎",
      features: ["Оружие +2 на выбор", "Кольцо +2", "Кольчуга +2", "Шлем +2", "Кольцо +2", "Питомец: осёл", "Золото"],
    ...
    },
    {
      ...
      price: 2000,
      currency: "💎",
      features: ["Трансформация в магазин - глобальные передачи, отсуствие возможности передвигаться и действовать"],
              ...
              {selectedProduct.id === 10 && (
                <div className="my-4">
                  ...
                  <Alert variant="warning" className="mt-3 fantasy-alert">
                    <strong>⚠️ Внимание!</strong> При покупке набора ваш текущий мул будет заменён на осла (грузоподъёмность 175 вместо 150).
                  </Alert>
                </div>
              )}
